...
```{r}
plot(1:100,ifelse(X==1,1,0),type="l", main="Actual Hidden States versus Predicted", ylab="State", xlab="Time")
...
kable(result$E, "html", digits=3, caption="Emission Probabilities")
kable(result$P, digits=3, caption="Transition Probabilities")
kable(result$pi, digits=3, caption="Starting Probabilities")

```

The resulting transition, emission and starting probability matrices do not look like the actual matrices used to generate the data. However, the log-likelihood of the observed data under this model is comparable to the log-likelihood under the true model. It appears that the Baum-Welsh Algorithm can easily get stuck in local optimums.
